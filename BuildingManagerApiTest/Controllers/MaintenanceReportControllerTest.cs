...
namespace BuildingManagerApiTest.Controllers
{
    ...
    public class MaintenanceReportControllerTest
    {
        ...
        public void GetMaintenanceReport_Ok()
        {
            ...
            mockReportLogic.Setup(x => x.GetReport()).Returns(_datas);
        ...
        {
            List<MaintenanceData> datas1 = [new MaintenanceData(3, 2, 1, 7, "John")];
            List<MaintenanceData> datas2 = [new MaintenanceData(3, 3, 1, 7, "John")];
