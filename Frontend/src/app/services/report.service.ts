...
export class ReportService {
  ...
  public getCategoriesReport(buildingId: string, filter: string): Observable<CategoriesReport> | null {
    let params = new HttpParams().set('categoryName', filter);
    return this.http.get<CategoriesReport>(`${environment.apiUrl}/reports/${buildingId}/categories`, { params: params });
  }
}