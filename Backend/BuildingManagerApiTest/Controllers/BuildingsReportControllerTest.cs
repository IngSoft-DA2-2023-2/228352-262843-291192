...
namespace BuildingManagerApiTest.Controllers
{
    ...
    public class BuildingsReportControllerTest
    {
        ...
        {
            _datas = [new ReportData(3, 2, 1, 7, "", new Guid("11111111-1111-1111-1111-111111111111"), "Electricista", null, null, null, "Building 1")];
        }
        [TestMethod]
        ...
        {
            List<ReportData> datas1 = [new ReportData(3, 2, 1, 7, "John", new Guid(), "Electricista", null, null, null, "Building 1")];
            List<ReportData> datas2 = [new ReportData(3, 3, 1, 7, "John", new Guid(), "Electricista", null, null, null, "Building 1")];
