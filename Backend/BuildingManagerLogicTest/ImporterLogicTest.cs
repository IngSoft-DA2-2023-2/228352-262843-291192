...
namespace BuildingManagerLogicTest
{
    ...
    public class ImporterLogicTest
    {
        ...
        public void ImportSuccessfully()
        {
            ...
            string data = "{\"edificios\":[{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":\"test@test.com\",\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]}]}";
            var userLogicMock = new Mock<IUserLogic>(MockBehavior.Strict);
            var companyLogicMock = new Mock<IConstructionCompanyLogic>(MockBehavior.Strict);
            var buildingLogicMock = new Mock<IBuildingLogic>(MockBehavior.Strict);
            var importerLogic = new ImporterLogic(userLogicMock.Object, companyLogicMock.Object, buildingLogicMock.Object);
            ...
            building.ManagerId = result[0].ManagerId;
            userLogicMock.VerifyAll();
            companyLogicMock.VerifyAll();
            buildingLogicMock.VerifyAll();
        ...
        [TestMethod]
        public void ImportWithManagerNullSuccessfully()
        {
            Guid sessionToken = Guid.NewGuid();
            Guid ccadminId = Guid.NewGuid();
            Guid companyId = Guid.NewGuid();
        ...
        public void ImportWithDuplicatedNameBuildings()
        {
            ...
            List<Building> buildings = new List<Building> { building };
            string importerName = "DefaultJson";
            string data = "{\"edificios\":[{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre1\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro1\"},\"encargado\":\"test@test.com\",\"gps\":{\"latitud\":-0.1764,\"longitud\":-78.483},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]},{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":null,\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]}]}";
            var userLogicMock = new Mock<IUserLogic>(MockBehavior.Strict);
            var companyLogicMock = new Mock<IConstructionCompanyLogic>(MockBehavior.Strict);
            var buildingLogicMock = new Mock<IBuildingLogic>(MockBehavior.Strict);
            var importerLogic = new ImporterLogic(userLogicMock.Object, companyLogicMock.Object, buildingLogicMock.Object);
        ...
        public void ImportWithDuplicatedAddressBuildings()
        {
            ...
            List<Building> buildings = new List<Building> { building };
            string importerName = "DefaultJson";
            string data = "{\"edificios\":[{\"nombre\":\"Lastorres1\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":\"test@test.com\",\"gps\":{\"latitud\":-0.1764,\"longitud\":-78.483},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]},{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":null,\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]}]}";
            var userLogicMock = new Mock<IUserLogic>(MockBehavior.Strict);
            var companyLogicMock = new Mock<IConstructionCompanyLogic>(MockBehavior.Strict);
            var buildingLogicMock = new Mock<IBuildingLogic>(MockBehavior.Strict);
            var importerLogic = new ImporterLogic(userLogicMock.Object, companyLogicMock.Object, buildingLogicMock.Object);
