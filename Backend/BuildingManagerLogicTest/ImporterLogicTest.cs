...
namespace BuildingManagerLogicTest
{
    ...
    public class ImporterLogicTest
    {
        ...
        public void ImportWithInvalidImporterName()
        {
            ...
            List<Building> buildings = new List<Building> { building };
            string importerName = "InvalidImporter";
            string data = "{\"edificios\":[{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":null,\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]}]}";
            ...
            try
            {
                importerLogic.ImportData(importerName, data, sessionToken);
            }
            catch (Exception ex)
            {
                exception = ex;
        ...
        [TestMethod]
        public void ImportWithDuplicatedNameBuildings()
        {
            Guid sessionToken = Guid.NewGuid();
            Guid ccadminId = Guid.NewGuid();
            Guid companyId = Guid.NewGuid();
            ...
            List<Building> buildings = new List<Building> { building };
            string importerName = "DefaultJson";
            string data = "{\"edificios\":[{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre1\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro1\"},\"encargado\":null,\"gps\":{\"latitud\":-0.1764,\"longitud\":-78.483},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]},{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":null,\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]}]}";
            var userLogicMock = new Mock<IUserLogic>(MockBehavior.Strict);
            var companyLogicMock = new Mock<IConstructionCompanyLogic>(MockBehavior.Strict);
            var buildingLogicMock = new Mock<IBuildingLogic>(MockBehavior.Strict);
            var importerLogic = new ImporterLogic(userLogicMock.Object, companyLogicMock.Object, buildingLogicMock.Object);
        ...
        [TestMethod]
        public void ImportWithDuplicatedAddressBuildings()
        {
            Guid sessionToken = Guid.NewGuid();
            Guid ccadminId = Guid.NewGuid();
            Guid companyId = Guid.NewGuid();
            ...
            List<Building> buildings = new List<Building> { building };
            string importerName = "DefaultJson";
            string data = "{\"edificios\":[{\"nombre\":\"Lastorres1\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":null,\"gps\":{\"latitud\":-0.1764,\"longitud\":-78.483},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]},{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":null,\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]}]}";
            var userLogicMock = new Mock<IUserLogic>(MockBehavior.Strict);
            var companyLogicMock = new Mock<IConstructionCompanyLogic>(MockBehavior.Strict);
            var buildingLogicMock = new Mock<IBuildingLogic>(MockBehavior.Strict);
            var importerLogic = new ImporterLogic(userLogicMock.Object, companyLogicMock.Object, buildingLogicMock.Object);
        ...
        [TestMethod]
        public void ImportWithDuplicatedLocationBuildings()
        {
            Guid sessionToken = Guid.NewGuid();
            Guid ccadminId = Guid.NewGuid();
            Guid companyId = Guid.NewGuid();
            ...
            List<Building> buildings = new List<Building> { building };
            string importerName = "DefaultJson";
            string data = "{\"edificios\":[{\"nombre\":\"Lastorres1\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre1\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro1\"},\"encargado\":null,\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]},{\"nombre\":\"Lastorres\",\"direccion\":{\"calle_principal\":\"Av.6deDiciembre\",\"numero_puerta\":3030,\"calle_secundaria\":\"Av.EloyAlfaro\"},\"encargado\":null,\"gps\":{\"latitud\":-0.176,\"longitud\":-78.48},\"gastos_comunes\":5000,\"departamentos\":[{\"piso\":1,\"numero_puerta\":101,\"habitaciones\":3,\"conTerraza\":false,\"baños\":2,\"propietarioEmail\":\"juan.perez@gmail.com\"}]}]}";
            var userLogicMock = new Mock<IUserLogic>(MockBehavior.Strict);
            var companyLogicMock = new Mock<IConstructionCompanyLogic>(MockBehavior.Strict);
            var buildingLogicMock = new Mock<IBuildingLogic>(MockBehavior.Strict);
            var importerLogic = new ImporterLogic(userLogicMock.Object, companyLogicMock.Object, buildingLogicMock.Object);
        ...
        [TestMethod]
        public void ImportWithExistingBuilding()
        {
            Guid sessionToken = Guid.NewGuid();
            Guid ccadminId = Guid.NewGuid();
            Guid companyId = Guid.NewGuid();
            ...
            buildingLogicMock.Setup(x => x.GetOwnerFromEmail(It.IsAny<string>())).Returns(owner);
            userLogicMock.Setup(x => x.GetManagerIdFromEmail(It.IsAny<string>())).Returns(managerId);
            buildingLogicMock.Setup(x => x.CheckIfBuildingExists(It.IsAny<Building>())).Returns(true);
