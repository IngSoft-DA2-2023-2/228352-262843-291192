...
namespace BuildingManagerDomainTest
{
    ...
    public class BuildingTest
    {
        ...
        [TestMethod]
        public void CreateBuildingWithNullOwnerLastNameTest()
        {
            Exception exception = null;
            try
            {
                var requestWithNullOwnerLastName = new CreateBuildingRequest()
                {
                    Name = "Building 1",
                    Address = "Address 1",
                    Location = "Location 1",
                    ...
                    Apartments = new List<Apartment>
                    {
                        new Apartment { Owner = new Owner { LastName = null } }
                    }
                };
            }
            catch (Exception ex)
        ...
        [TestMethod]
        public void CreateBuildingWithNullOwnerEmailTest()
        {
            Exception exception = null;
            try
            {
                var requestWithNullOwnerEmail = new CreateBuildingRequest()
                {
                    Name = "Building 1",
                    Address = "Address 1",
                    Location = "Location 1",
                    ...
                    Apartments = new List<Apartment>
                    {
                        new Apartment { Owner = new Owner { Email = null } }
                    }
                };
            }
            catch (Exception ex)
        ...
        [TestMethod]
        public void CreateBuildingWithSpaceEmailOwnerTest()
        {
            Exception exception = null;
            try
            {
                var requestWithSpaceEmailOwner = new CreateBuildingRequest()
                {
                    Name = "Building 1",
                    Address = "Address 1",
                    Location = "Location 1",
                    ...
                    Apartments = new List<Apartment>
                    {
                        new Apartment { Owner = new Owner { Email = " " } }
                    }
                };
            }
            catch (Exception ex)
        ...
        [TestMethod]
        public void CreateBuildingWithInvalidEmailOwnerTest()
        {
            Exception exception = null;
            try
            {
                var requestWithInvalidEmailOwner = new CreateBuildingRequest()
                {
                    Name = "Building 1",
                    Address = "Address 1",
                    Location = "Location 1",
